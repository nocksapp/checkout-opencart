...
require_once(dirname(DIR_SYSTEM) . '/catalog/model/extension/payment/nocks/NocksApi.php');

class ControllerExtensionPaymentNocksIdeal extends NocksPaymentCatalogController {
